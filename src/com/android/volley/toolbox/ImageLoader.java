...
public class ImageLoader {
    ...
    public ImageContainer get(String requestUrl, ImageListener imageListener,
        ...
        if (RecyclingImageView.class.isInstance(imageView)) {
            RecyclingImageView recyclingImage = (RecyclingImageView) imageView;
            recyclingImage.cancelOldRequest();
            recyclingImage.setImageContainer(imageContainer);
        }
        if (LruBitmapCache.class.isInstance(mCache)) {
            newRequest.setLruBitmapCache((LruBitmapCache)mCache);
        }
